    ...
    <>
      ...
      <div>
        <Prose>
          ...
          <p>
            Dagster is a data orchestrator for machine learning, analytics, and
            ETL.
          </p>
        </Prose>
        ...
        <div className="prose max-w-none">
          <p>
            Dagster lets you define pipelines in terms of the data flow between
            reusable, logical components, then test locally and run anywhere.
            With a unified view of pipelines and the assets they produce,
            Dagster can schedule and orchestrate Pandas, Spark, SQL, or anything
            else that Python can invoke.
          </p>

          <p>
            Dagster is designed for data platform engineers, data engineers, and
            full-stack data scientists. Building a data platform with Dagster
            makes your stakeholders more independent and your systems more
            robust. Developing data pipelines with Dagster makes testing easier
        ...
        <Prose>
          ...
          <p>
            ...
            in-process against your local file system, or on a distributed work
            queue against your production data lake. You can set up Dagster’s
            web interface in a minute on your laptop, or deploy it on-premise or
            in any cloud.
          </p>
          ...
          <p>
            Dagster models data dependencies between steps in your orchestration
            graph and handles passing data between them. Optional typing on
            inputs and outputs helps catch bugs early.
          </p>
          <h3 id="link-data-to-computations">Link data to computations</h3>
          <p>
            Dagster’s Asset Manager tracks the data sets and ML models produced
            by your pipelines, so you can understand how your they were
            generated and trace issues when they don’t look how you expect.
          </p>
          ...
          <h3 id="avoid-dependency-nightmares">Avoid dependency nightmares</h3>
          <p>
            ...
            can have its own package dependencies and Python version. Pipelines
            run in isolated processes so user code issues can&#39;t bring the
            system down.
          </p>
          ...
          <p>
            ...
            consuming tasks via a Gantt chart, re-execute subsets of steps, and
            more.
          </p>
        </Prose>
      </div>
